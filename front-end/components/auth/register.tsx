...
export default function RegisterUI() {
    ...
    const HandleSetAboutMe = (event: React.ChangeEvent<HTMLTextAreaElement>) => setAbout(event.target.value)
    ...
    <form className={style.registerMainCont} action="">
      <div className={style.imageAndData}>
        ...
        <div className={style.registerCont}>
            <p className={style.removeRegister}>x</p>
          <div>
        ...
        <p className={style.backLogin}>Have account <span style={{color: "var(--primary-theme)", cursor: "pointer"}}>login</span></p>
          </div>
        </div>
      </div>
    </form>
